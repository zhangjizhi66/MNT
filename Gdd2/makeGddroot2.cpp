...
Short_t sthetaP,smassP;  // scattering angle, mass of PLF

int main(int argc, char** argv)
{
    if (argc != 3){
        printf("USAGE: ./makeGddroot2 runid_1 runid_2");
        exit(EXIT_FAILURE);
    }
    ...
    const char *filename = Form("ROOT/Gdd2_%d_%d.root",atoi(argv[1]),atoi(argv[2]));
    ...
    opt->Branch("thetaP",&sthetaP,"thetaP/S");
    opt->Branch("massP",&smassP,"massP/S");
